...
ROLE_RULES = {
    "Membership Manager": {
        "members": [
            ...
            "view_membershipcategory", "add_membershipcategory", "change_membershipcategory",
            "view_organizationunit", "add_organizationunit", "change_organizationunit",
            "view_membershipnumbersequence", "view_membershipnumberissue",
    ...
    "Payment Reviewer": {
        ...
        "core": ["view_membership", "view_membershippaymentsettings"],
    },
}
