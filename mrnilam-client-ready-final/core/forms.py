...
class MembershipForm(forms.ModelForm):
    ...
    consent_to_privacy = forms.BooleanField(
        required=True,
        label=_("I have read the privacy information and consent to the use of my details for this membership application."),
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        for name, field in self.fields.items():
            if name not in {"website", "form_started", "consent_to_privacy"}:
    ...
    def clean_consent_to_privacy(self):
        ...
        if not value:
            raise ValidationError(_("Privacy consent is required to submit a membership application."))
        return value
