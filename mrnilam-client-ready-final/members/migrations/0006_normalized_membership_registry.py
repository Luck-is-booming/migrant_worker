...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(model_name="importbatch", index=models.Index(fields=["source_checksum", "status"], name="members_imp_source__3cf2f7_idx")),
        migrations.AddIndex(model_name="person", index=models.Index(fields=["is_public", "normalized_name"], name="members_per_is_publ_0e9b4d_idx")),
        migrations.AddIndex(model_name="person", index=models.Index(fields=["phone"], name="members_per_phone_101b30_idx")),
        migrations.AddIndex(model_name="membershiprecord", index=models.Index(fields=["person", "status", "is_public"], name="members_mem_person__595e95_idx")),
        migrations.AddIndex(model_name="membershiprecord", index=models.Index(fields=["category", "organization_unit"], name="members_mem_categor_03f66b_idx")),
        migrations.AddIndex(model_name="membershiprecord", index=models.Index(fields=["organization_unit", "membership_number_int"], name="members_mem_organiz_736b64_idx")),
