...
from members.models import Member, MembershipRecord, split_source_language
            ...
            with transaction.atomic():
                ...
                for data in rows:
                    ...
                    if existing:
                        ...
                        designation_ne, designation_en = split_source_language(data["designation"])
                        address_ne, address_en = split_source_language(data["address"])
                        if not existing.designation_ne and not existing.designation_en:
                            existing.designation_ne = designation_ne
                            existing.designation_en = designation_en
                        if not existing.address_display_ne and not existing.address_display_en:
                            existing.address_display_ne = address_ne
                            existing.address_display_en = address_en
